	...
	public static void main(String[] args) throws InterruptedException {
	 System.setProperty("webdriver.chrome.driver", "C:\\SeleniumDriver\\chromedriver_win32\\chromedriver.exe");
	   ...
	   //Thread.sleep(1000);
		...
		//String OrderNumber =driver.findElement(By.xpath("(//*[contains (text(),'28')])[2]")).getText();
		String orderN =driver.findElement(By.xpath("//li[@class='order']")).getText();
		System.out.println("your order number is "+" "+orderN);
		//driver.quit();
