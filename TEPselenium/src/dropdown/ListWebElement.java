...
public class ListWebElement {
	...
	public static void main(String[] args) {
		...
		// with getOptions(),you only can work outside of the drop down box. to go
		// inside you need List<WebElement> method and a loop
		...
		// month.getOptions() is a method, number is a reference object name and
		// List<WebElements> is a data type and a method.

		int list = number.size();
		System.out.println("total month number is" + "  " + list);
		// i=0 and i<list, that means in between everything is =i, for example in this
		// drop down box list
